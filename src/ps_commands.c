...
{
	int	temp = pop_back_ft_deque_int(x_stack->numbers);
	push_front_ft_deque_int(x_stack->numbers, temp);
	ft_printf("r%s\n", x_stack->name);
}

void	rrx(t_ps_stack *x_stack)
{
	int	temp = pop_front_ft_deque_int(x_stack->numbers);
	push_back_ft_deque_int(x_stack->numbers, temp);
	ft_printf("rr%s\n", x_stack->name);
}
